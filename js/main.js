...
var text4_1 = d3.select(".forthmap").append("p").style("padding-left", "50px").style("padding-right", "50px").style("font-size", "16px")
  .text("From 2010 to 2014, the honey price went up rapidly until 2014 when the honey production peaked up. The honey price then dropped a little bit and increased slowly until 2018. In 2019, for some reasons (e.g., the honey production climbed slightly), the price dropped a lot. Spatially, Virginia and New Jersey were always first two states that responded to the rising price. States in the southeast and states close to the Great Lakes have higher honey price, and the price did not drop when there was a nationwide trend of decline. The highest price is 5 times of the lowest price!")
...
var text5_1 = d3.select(".fifthmap").append("p").style("padding-left", "50px").style("padding-right", "50px").style("font-size", "16px")
  .text("In 2018 the US imported over 190,000 tonnes of honey. Our honey are mostly from three countries: India, Vietnam and Argentina, which altogether account for nearly 63 percent of US honey imports. We also exported 3,700+ tonnes of honey to a few countries like Philippines and Canada.")
